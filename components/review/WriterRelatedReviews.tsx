			...
			<ul className="flex flex-col gap-4 items-center mt-4">
				{selectedReviewsByUsername
					...
					.map(({ id, content, title, course }) => (
						<li
							key={id}
							className="w-full border-[1px] border-gray-50 rounded-lg bg-gray-100 hover:border-gray-300 hover:bg-gray-200 transition-colors">
							<Link href={`/reviews/${id}`} className="flex flex-col gap-2 px-4 py-2 ">
